 ...
 */
@Autonomous(name="Audience_Blue_Three",group="Auton")
@Disabled
public class Audience_Blue_Three extends OpMode {
    ...
    static final double WHEEL_DIAMETER_INCHES = 5.6;
        ...
        switch (state) {
            ...
            case 3:
                ...
                if (ALLIANCE_COLOR.equals("Red")){
                    if (encoderIMUdrive(distance, -.4, 0)) {
                        fastNextState();//state++;
                    }
                } else{
                    if (encoderIMUdrive(distance, .4, 0)) {
            ...
            case 12:
                ...
                relicClamp.setPosition(RELIC_CLAMP_LOCK);
                relicArm.setPosition(RELIC_ARM_LOWERED);
                if (encoderIMUdrive(-(3+(encoderCount)/COUNTS_PER_INCH), -FAST_DRIVE_SPEED, boxAngle)) {
                    nextState();
                }
                break;

 ...
 */
@Autonomous(name="Corner_Red_Three",group="Auton")
@Disabled
public class Corner_Red_Three extends OpMode {
    ...
    // *********************************************
    static final double STONE_TO_BOX_DIST                           = 16;
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 11:
                ...
                if (encoderIMUdrive(REVERSE_DIST + 8, FAST_DRIVE_SPEED, ANGLE_OF_PIT_RED)) {
                    jewelPivot.setPosition(JEWEL_PIVOT_RAISED);
                    jewelArm.setPosition(JEWEL_ARM_RAISED);
                    alignArm.setPosition(ALIGN_ARM_LOWERED);
                    glyphClamp.setPosition(GLYPH_CLAMP_UNLOCK);

 ...
 */
@Autonomous(name="Corner_Blue_Three",group="Auton")
@Disabled
public class Corner_Blue_Three extends OpMode {
    ...
    static final double P_C_TURN = 0.005;
    ...
    // *********************************************
    static final double STONE_TO_BOX_DIST                           = 18;
    ...
    static final double RIGHT_COL_DIST_BLUE                         = 20 + 6.5;
    static final double LEFT_COL_DIST_BLUE                          = 20 - 4.5;         // Angle to face the blue cryptobox
    static final double CENTER_COL_DIST_RED                         = -20;
    static final double RIGHT_COL_DIST_RED                          = -(20 - 6);
    static final double LEFT_COL_DIST_RED                           = -(20 + 5);
    static final double ANGLE_OF_BOX_BLUE                               = 179.5;              // Angle to face the blue cryptobox
    static final double ANGLE_OF_BOX_RED                                = 0;
    static final double ANGLE_OF_PIT_RED                            = -20;
    static final double ANGLE_OF_PIT_BLUE                           = 20;
    ...
    public void init() {
        ...
        alignArm.setPosition(ALIGN_ARM_IN-.15);
    ...
    public void loop() {
        ...
        telemetry.addData("Power fL", frontLeftMotor.getCurrentPosition() );
        telemetry.addData("Power rL", rearLeftMotor.getCurrentPosition() );
        telemetry.addData("Power fR", frontRightMotor.getCurrentPosition() );
        telemetry.addData("Power rR", rearRightMotor.getCurrentPosition() );
        ...
        switch (state) {
            ...
            case 5:
                ...
                if (angleDrive(strafeDist, STRAFE_SPEED, strafeDir, 180)) {
                    nextState();
                }
                break;
            ...
            case 8:
                ...
                if (encoderIMUdrive(GLYPH_PUSH_DIST, -SLOW_DRIVE_SPEED, 180)) {
                    nextState();
                }
                break;

            // Move parking distance to allow turning for glyph pit angle
            case 9:
                if (secondRun) {
                    alignArm.setPosition(ALIGN_ARM_RAISED);
                    goToState(18);
            ...
            case 11:
                ...
                if (encoderIMUdrive(REVERSE_DIST + 8, FAST_DRIVE_SPEED, ANGLE_OF_PIT_BLUE)) {
                    jewelPivot.setPosition(JEWEL_PIVOT_RAISED);
                    jewelArm.setPosition(JEWEL_ARM_RAISED);
                    alignArm.setPosition(ALIGN_ARM_LOWERED);
                    glyphClamp.setPosition(GLYPH_CLAMP_UNLOCK);
            ...
            case 15:
                ...
                relicClamp.setPosition(RELIC_CLAMP_LOCK);
                relicArm.setPosition(RELIC_ARM_LOWERED);
                if (encoderIMUdrive(-(3+(encoderCount)/COUNTS_PER_INCH), -FAST_DRIVE_SPEED, ANGLE_OF_PIT_RED)) {
                    nextState();
                }
                break;

            // Reposition to face the cryptobox
            case 16:
                if (turn(0)) {
                    nextState();
                }

 ...
 */
@Autonomous(name="Alignment Test",group="Auton")
@Disabled
public class Align_Test extends OpMode {
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 0:
                ...
                telemetry.addData("Not Pressed: ", digitalTouch.getState());
                break;
    ...
    */
    ...
    public boolean resetDelay(){
        if (frontRightMotor.getCurrentPosition() == 0 || frontLeftMotor.getCurrentPosition() == 0){

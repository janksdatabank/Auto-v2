 ...
 */
@Autonomous(name="Test Autonomous Omnis",group="Auton")
//@Disabled
public class TestAutoDriveCoordinates extends OpMode {
    ...
    public void init() {
        ...
        this.positionTracking = new PositionTracking(this,imu3,rightIntake,Extension,frontLeftMotor,rearLeftMotor,frontRightMotor,rearRightMotor);
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            if (positionTracking.autonomousDrive((int)(5*positionTracking.xPerInch),-(int)(5*positionTracking.yPerInch),0,0)) {
                fastNextState();
            } else {

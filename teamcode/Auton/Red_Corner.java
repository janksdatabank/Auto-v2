 ...
 */
@Autonomous(name="Red_Corner",group="Auton")
@Disabled
public class Red_Corner extends OpMode {
    ...
    static final double STRAFE_DIST_LEFT_RED                            = (5.5+3.75);                // The distance when strafing from the left to center column
    static final double STRAFE_DIST_CENTER_RED                          = 5.5;
    static final double STRAFE_DIST_RIGHT_RED                           = (5.5 - 3.75);
    ...
    public void loop() {
        ...
        switch (state) {
            ...
            case 4:
                if (Center) {
                    strafeDist = STRAFE_DIST_CENTER_RED;
                }
                else if (Left) {
                    strafeDist = STRAFE_DIST_LEFT_RED;
                }
                else  {
                    strafeDist = STRAFE_DIST_RIGHT_RED;
                }
            ...
            case 8:
                ...
                if (secondRun) {
                    ...
                    if (encoderIMUdrive(4, FAST_DRIVE_SPEED, boxAngle)) {
                        jewelPivot.setPosition(JEWEL_PIVOT_RAISED);
                        jewelArm.setPosition(JEWEL_ARM_RAISED);
                        alignArm.setPosition(ALIGN_ARM_LOWERED);
                        glyphClamp.setPosition(GLYPH_CLAMP_UNLOCK);
